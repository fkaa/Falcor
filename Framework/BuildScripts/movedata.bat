...
robocopy %ExternalsSourceDirectory%\..\..\Fove\lib %DestinationDirectory%  *.lib /r:0 >nul
robocopy %ExternalsSourceDirectory%\..\..\Fove\bin %DestinationDirectory%  *.dll /r:0 >nul
echo %1
